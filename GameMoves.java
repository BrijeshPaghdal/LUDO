...
public class GameMoves extends JPanel implements KeyListener, ActionListener,MouseListener{
	...
	private static final int LOCX = 650;
	...
	public Dimension getPreferredSize() {
		return new Dimension(SIDE * 2, SIDE * 2);
	}

	private void diceRoll(Graphics g){
			
			g.setColor(Color.WHITE);
			g.fillRect(LOCX - 7, LOCY - 8, SIDE*5, SIDE*5);
			g.setColor(Color.BLACK);
			 switch (dice) {
				case 1:
				g.fillRect(12 + LOCX, 12 + LOCY, SIDE, SIDE);
				break;
				case 2:
				g.fillRect(25 + LOCX, LOCY, SIDE, SIDE);
				g.fillRect(LOCX, 25 + LOCY, SIDE, SIDE);
				break;
				case 3:
				g.fillRect(LOCX, 12 + LOCY, SIDE, SIDE);
				g.fillRect(LOCX +12, 12 + LOCY, SIDE, SIDE);
				g.fillRect(25 +  LOCX, 12 + LOCY, SIDE, SIDE);
				break;
				case 4:
				g.fillRect(LOCX, LOCY, SIDE, SIDE);
				g.fillRect(25 +  LOCX, 25 + LOCY, SIDE, SIDE);
				g.fillRect(25 + LOCX, LOCY, SIDE, SIDE);
				g.fillRect(LOCX, 25 + LOCY, SIDE, SIDE);
				break;
				case 5:
    ...
    public void paint(Graphics g) {
    	...
    	if(p.pl[current_player].coin==4) {
            ...
            g.drawString("Player "+(current_player+1)+" wins.", 600, 160);
            ...
            g.drawString("Player "+(current_player+1), 615, 150);
	...
	public void mouseClicked(MouseEvent e) {
		int dx = e.getX();
		int dy = e.getY();
		if( dx >= LOCX - 7 && dx <= LOCX + (SIDE*5) && dy >= LOCY - 8 && dy <= LOCY + (SIDE*5) && flag==0 )
		{
			rollDice();
		}
		else if(flag==1) {
